...
public class IntgAuthSignRequest {
	...
	public static class Consent {
		...
		@ApiModelProperty(value = "정보제공자 기관코드(org_code)", dataType = "string", example = "MOC9999999")
		private String sndOrgCode;
		
		@ApiModelProperty(value = "마이데이터사업자(정보수신자) 기관코드(org_code)", dataType = "string", example = "MOC1234567")
		private String rcvOrgCode;
		
		@ApiModelProperty(value = "정기적 전송 여부(true 또는 false)", dataType = "string", example = "true")
		private boolean isScheduled;
		
		private Cycle cycle;
		
		@ApiModelProperty(value = "전송요구의 종료시점", dataType = "string", example = "20221231235959")
		private String endDate;
		
		@ApiModelProperty(value = "전송을 요구하는 목적", dataType = "string", example = "통합계좌 마이데이터 서비스 제공")
		private String purpose;
		
		@ApiModelProperty(value = "전송을 요구하는 개인신용정보의 보유기간", dataType = "string", example = "20221231235959")
	...
	public static class Cycle {
		@ApiModelProperty(value = "정기적 전송 주기 단위", dataType = "string", example = "1/w")
		private String fndCycle;
		
		@ApiModelProperty(value = "추가 정보의 정기적 전송 주기 단위", dataType = "string", example = "1/d")
	...
	public static class TargetInfo {
		@ApiModelProperty(value = "전송요구 정보에 해당하는 Scope", dataType = "string", example = "invest.list")
	...
	public static class Asset {
		@ApiModelProperty(value = "전송요구 대상 계좌(상품) 식별자", dataType = "string", example = "all_asset")
